# SQLi — SQL injection vulnerability allowing UNION attack to retrieve data from other tables

**Lab:** SQL injection vulnerability allowing UNION attack to retrieve data from other tables  
**Уровень:** Apprentice  
**Статус:** Solved
